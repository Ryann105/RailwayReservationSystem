...
public class BookingController {
	...
	public ResponseEntity<String> deleteBooking(@PathVariable Integer id) throws BookingNotFoundException {
		int count=1;
...
public Booking updateBooking(@RequestBody Booking book,@PathVariable Integer id) throws BookingNotFoundException {
	Booking bok = bookingServiceimpl.updateBooking(book, id);
	return bok;
}
